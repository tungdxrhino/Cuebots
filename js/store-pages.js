(() => {
  ...
  const PRODUCTS = [
    { id: "rhino-30-125", slug: "rhino-30-125", name: "Rhino 30-inch 12.5mm Carbon Shaft", price: 199, oldPrice: 229, image: "catalog/thumb-carbon-shafts-catalog-1x1-01.jpg", tags: ["shaft", "play", "upgrade"], detail: true, copy: "Low-deflection carbon response with a stable, familiar 12.5 mm profile." },
    { id: "z-fusion-limited", slug: "z-fusion-limited", name: "Z Fusion Limited Pool Cue", price: 319, oldPrice: 359, image: "catalog/thumb-pool-cues-catalog-1x1-01.jpg", tags: ["play", "butt", "control"], detail: true, copy: "A distinctive playing cue balanced for smooth delivery and confident cue-ball control." },
    { id: "nebula-carbon-cue", slug: "nebula-carbon-cue", name: "Rhino Nebula Carbon Pool Cue", price: 299, oldPrice: 349, image: "products/prod-nebula-carbon-pool-cue-collection-1x1-01.jpg", tags: ["play", "bundle", "control"], detail: true, copy: "Cosmic color, carbon consistency and a natural balance for league and tournament play." },
    { id: "rhino-carbon-break-cue", slug: "rhino-carbon-break-cue", name: "Rhino Carbon Break Cue", price: 249, oldPrice: 289, image: "products/prod-break-power-collection-1x1-01.jpg", tags: ["break", "power"], detail: true, copy: "Purpose-built stiffness and efficient energy transfer for a stronger, controlled break." },
    { id: "retro-ii-carbon-set", slug: "retro-ii-carbon-set", name: "Retro II Carbon Cue Set", price: 329, oldPrice: 369, image: "products/prod-retro-ii-carbon-pool-cue-collection-1x1-01.jpg", tags: ["play", "bundle", "control"], detail: true, copy: "Classic visual detail paired with modern carbon performance in a complete setup." },
    { id: "carbon-shaft-starter-bundle", slug: "carbon-shaft-starter-bundle", name: "Carbon Shaft Starter Bundle", price: 279, oldPrice: 319, image: "products/prod-carbon-shaft-starter-bundle-1x1-01.jpg", tags: ["shaft", "upgrade", "bundle", "accessory"], detail: true, copy: "A focused shaft upgrade with the accessories needed to keep your setup match-ready." },
    { id: "nebula-pro-bundle", slug: "nebula-pro-bundle", name: "Nebula Pro Player Bundle", price: 359, oldPrice: 419, image: "products/prod-nebula-carbon-pool-cue-collection-1x1-01.jpg", tags: ["play", "bundle", "control"], detail: true, copy: "A coordinated cue, case and playing essentials package with no guesswork." },
    { id: "break-jump-power-duo", slug: "break-jump-power-duo", name: "Break and Jump Power Duo", price: 399, oldPrice: 479, image: "products/prod-break-jump-power-duo-1x1-01.jpg", tags: ["break", "jump", "power", "bundle"], detail: true, copy: "Two purpose-built cues for the opening shot and difficult recovery situations." },
    { id: "rhino-118-shaft", name: "Rhino 11.8mm Carbon Shaft", price: 199, oldPrice: 229, image: "catalog/thumb-carbon-shafts-catalog-1x1-01.jpg", tags: ["shaft", "upgrade", "control"], copy: "A slim, precise profile for players who prefer maximum visual feedback." },
    { id: "nitro-128-shaft", name: "Nitro 12.8mm Carbon Shaft", price: 229, oldPrice: 259, image: "products/prod-nitro-128-carbon-pool-shaft-1x1-01.png", tags: ["shaft", "break", "power"], copy: "A robust carbon profile tuned for a solid hit and confident acceleration." },
    { id: "z-fusion-emerald", name: "Z Fusion Emerald Cue", price: 329, oldPrice: 379, image: "catalog/thumb-pool-cues-catalog-1x1-01.jpg", tags: ["play", "butt", "control"], copy: "A statement finish over a stable, competition-ready playing platform." },
    { id: "carbon-jump-cue", name: "Compact Carbon Jump Cue", price: 169, oldPrice: 199, image: "catalog/thumb-jump-cues-catalog-1x1-01.jpg", tags: ["jump", "control"], copy: "Compact handling and fast elevation for controlled jump-shot execution." },
    { id: "first-carbon-kit", name: "First Carbon Cue Starter Kit", price: 299, oldPrice: 369, image: "products/prod-first-carbon-cue-collection-1x1-01.jpg", tags: ["play", "bundle", "starter"], copy: "A complete first setup designed to remove uncertainty from your first carbon cue." },
    { id: "single-playing-butt", name: "Carbon Playing Butt — Midnight", price: 189, oldPrice: 229, image: "catalog/thumb-cue-butts-catalog-1x1-01.jpg", tags: ["butt", "play"], copy: "A balanced single butt ready to pair with your preferred shaft and joint." },
    { id: "hard-travel-case", name: "Tournament Hard Cue Case", price: 119, oldPrice: 139, image: "setups/thumb-tournament-setup-recommended-1x1-01.jpg", tags: ["case", "accessory"], copy: "Protective storage for travel, league nights and long tournament weekends." },
    { id: "soft-cue-case", name: "Lightweight Soft Cue Case", price: 69, oldPrice: 79, image: "setups/thumb-league-night-setup-recommended-1x1-01.jpg", tags: ["case", "accessory"], copy: "Streamlined everyday protection with room for the equipment you use most." },
    { id: "pure-glove-grey", name: "Pure Performance Glove — Grey", price: 24, oldPrice: 29, image: "reviews/thumb-pure-pool-glove-grey-review-1x1-01.jpg", tags: ["glove", "accessory", "control"], copy: "Low-friction bridge movement with a close, comfortable competition fit." },
    { id: "evo-glove-black", name: "Evo Player Glove — Black", price: 29, oldPrice: 34, image: "reviews/thumb-evo-pool-glove-black-review-1x1-01.jpg", tags: ["glove", "accessory", "control"], copy: "Breathable support and consistent glide through long practice sessions." },
    { id: "joint-protector-set", name: "Carbon Joint Protector Set", price: 19, oldPrice: 24, image: "catalog/thumb-accessories-catalog-1x1-01.jpg", tags: ["accessory", "shaft", "case"], copy: "Simple protection for cue joints during transport and storage." },
    { id: "performance-care-kit", name: "Cue Performance Care Kit", price: 39, oldPrice: 49, image: "catalog/thumb-accessories-catalog-1x1-01.jpg", tags: ["accessory", "case", "glove"], copy: "Compact maintenance essentials for clean, consistent equipment." }
  ];

  const GLOVE_COLORS = [
    { name: "Black", hex: "#151515", left: "products/gloves/prod-pure-pool-glove-left-black-1x1-01.jpg", right: "products/gloves/prod-pure-pool-glove-right-black-1x1-01.jpg" },
    { name: "Blue", hex: "#315f9a", left: "products/gloves/prod-pure-pool-glove-left-blue-1x1-01.jpg", right: "products/gloves/prod-pure-pool-glove-right-blue-1x1-01.jpg" },
    { name: "Grey", hex: "#8b9199", left: "products/gloves/prod-pure-pool-glove-left-grey-1x1-01.jpg", right: "products/gloves/prod-pure-pool-glove-right-grey-1x1-01.jpg" },
    { name: "Olive", hex: "#73745a", left: "products/gloves/prod-pure-pool-glove-left-olive-1x1-01.jpg", right: "products/gloves/prod-pure-pool-glove-right-olive-1x1-01.jpg" },
    { name: "Red", hex: "#a53336", left: "products/gloves/prod-pure-pool-glove-left-red-1x1-01.jpg", right: "products/gloves/prod-pure-pool-glove-right-red-1x1-01.jpg" }
  ];
  ...
  const GLOVE_PACKS = [
    { id: "pure-glove-pack-3-black", name: "Pure Glove 3-Pack — Black", price: 30, oldPrice: 36, image: "products/gloves/prod-pure-pool-glove-pack-3-black-1x1-01.png", tags: ["glove", "bundle"], hand: "Both", color: "Black", sizes: ["M", "L", "XL", "2XL"], copy: "Three dependable black gloves for regular practice, league and tournament rotation." },
    { id: "pure-glove-pack-3-grey", name: "Pure Glove 3-Pack — Grey", price: 30, oldPrice: 36, image: "products/gloves/prod-pure-pool-glove-pack-3-grey-1x1-01.png", tags: ["glove", "bundle"], hand: "Both", color: "Grey", sizes: ["M", "L", "XL", "2XL"], copy: "A practical three-glove pack with the same low-friction performance in grey." },
    { id: "pure-glove-pack-3-olive", name: "Pure Glove 3-Pack — Olive", price: 30, oldPrice: 36, image: "products/gloves/prod-pure-pool-glove-pack-3-olive-1x1-01.png", tags: ["glove", "bundle"], hand: "Both", color: "Olive", sizes: ["M", "L", "XL", "2XL"], copy: "Three olive Pure gloves that keep a fresh match-ready option close at hand." },
    { id: "pure-glove-pack-3-mixed", name: "Pure Glove 3-Pack — Mixed", price: 32, oldPrice: 39, image: "products/gloves/prod-pure-pool-glove-pack-3-mixed-1x1-01.png", tags: ["glove", "bundle"], hand: "Both", color: "Mixed", sizes: ["M", "L", "XL", "2XL"], copy: "Three core colors in one easy-value pack for players who like to rotate their look." },
    { id: "pure-glove-pack-5-mixed", name: "Pure Glove 5-Pack — Full Color", price: 48, oldPrice: 60, image: "products/gloves/prod-pure-pool-glove-pack-5-mixed-1x1-01.png", tags: ["glove", "bundle"], hand: "Both", color: "Mixed", sizes: ["M", "L", "XL", "2XL"], copy: "The full Pure color lineup with stronger multi-buy value for frequent players." }
  ];
  ...
  function productFromQuery() {
    ...
    const imageFile = /^(?:[a-z0-9-]+\/){0,3}[a-z0-9@._ -]+\.(?:jpe?g|png|webp)$/i.test(rawImage) ? rawImage : "catalog/thumb-accessories-catalog-1x1-01.jpg";
  ...
  const COLLECTIONS = {
    "pool-cues": { title: "Pool Cues", eyebrow: "Build your playing setup", description: "Complete carbon cues selected for consistent feedback, balance and cue-ball control.", image: "collections/hero-pool-cues-collection-desktop-01.jpg", mobileImage: "collections/hero-pool-cues-collection-mobile-01.jpg", relatedImage: "collections/thumb-pool-cues-related-5x3-01.jpg", tags: ["play", "control"], related: ["carbon-shafts", "cue-butts", "accessories"] },
    "break-cues": { title: "Break Cues", eyebrow: "Own the opening shot", description: "Purpose-built cues that deliver efficient power without sacrificing cue-ball control.", image: "collections/hero-break-cues-collection-desktop-01.jpg", mobileImage: "collections/hero-break-cues-collection-mobile-01.jpg", relatedImage: "collections/thumb-break-cues-related-5x3-01.jpg", tags: ["break", "power"], related: ["jump-cues", "break-power", "cases"] },
    "jump-cues": { title: "Jump Cues", eyebrow: "Create a way out", description: "Compact, responsive jump cues for clean elevation and difficult recovery shots.", image: "collections/hero-jump-cues-collection-desktop-01.jpg", mobileImage: "collections/hero-jump-cues-collection-mobile-01.jpg", relatedImage: "collections/thumb-jump-cues-related-5x3-01.jpg", tags: ["jump"], related: ["break-cues", "difficult-shots", "accessories"] },
    "carbon-shafts": { title: "Carbon Shafts", eyebrow: "Change the feel, keep your butt", description: "Low-deflection carbon shafts in player-focused profiles for a more predictable stroke.", image: "collections/hero-carbon-shafts-collection-desktop-01.jpg", mobileImage: "collections/hero-carbon-shafts-collection-mobile-01.jpg", relatedImage: "collections/thumb-carbon-shafts-related-5x3-01.jpg", tags: ["shaft"], related: ["upgrade-my-shaft", "cue-butts", "accessories"] },
    "cue-butts": { title: "Single Butts", eyebrow: "Build it your way", description: "Balanced cue butts ready to pair with the shaft, joint and playing feel you prefer.", image: "collections/hero-cue-butts-collection-desktop-01.jpg", mobileImage: "collections/hero-cue-butts-collection-mobile-01.jpg", relatedImage: "collections/thumb-cue-butts-related-5x3-01.jpg", tags: ["butt"], related: ["shop-cue-butts", "carbon-shafts", "cases"] },
    "accessories": { title: "Accessories", eyebrow: "Keep every setup match-ready", description: "Gloves, cases, protectors and care essentials that support consistent performance.", image: "collections/hero-accessories-collection-desktop-01.jpg", mobileImage: "collections/hero-accessories-collection-mobile-01.jpg", relatedImage: "collections/thumb-accessories-related-5x3-01.jpg", tags: ["accessory"], related: ["cases", "gloves", "carbon-shafts"] },
    "first-carbon-cue": { title: "First Carbon Cue", eyebrow: "Start strong", description: "Complete cue and accessory combinations chosen to make your first carbon setup simple.", image: "collections/hero-first-carbon-cue-collection-desktop-01.jpg", mobileImage: "collections/hero-first-carbon-cue-collection-mobile-01.jpg", relatedImage: "collections/thumb-first-carbon-cue-related-5x3-01.jpg", tags: ["starter", "bundle", "play"], related: ["pool-cues", "cases", "gloves"] },
    "upgrade-my-shaft": { title: "Upgrade My Shaft", eyebrow: "A focused performance upgrade", description: "Shafts and supporting essentials for a meaningful change without replacing your cue butt.", image: "collections/hero-upgrade-my-shaft-collection-desktop-01.jpg", mobileImage: "collections/hero-upgrade-my-shaft-collection-mobile-01.jpg", relatedImage: "collections/thumb-upgrade-my-shaft-related-5x3-01.jpg", tags: ["upgrade", "shaft", "accessory"], related: ["carbon-shafts", "cue-butts", "accessories"] },
    "shop-cue-butts": { title: "Shop Cue Butts", eyebrow: "Mix, match and refine", description: "Cue butts, shafts and protection selected for players building a personalized combination.", image: "collections/hero-shop-cue-butts-collection-desktop-01.jpg", mobileImage: "collections/hero-shop-cue-butts-collection-mobile-01.jpg", relatedImage: "collections/thumb-shop-cue-butts-related-5x3-01.jpg", tags: ["butt", "shaft", "play"], related: ["cue-butts", "carbon-shafts", "cases"] },
    "break-power": { title: "Get More Break Power", eyebrow: "Power with a plan", description: "Break cues, shafts and paired setups selected for stronger, more efficient opening shots.", image: "collections/hero-break-power-collection-desktop-01.jpg", mobileImage: "collections/hero-break-power-collection-mobile-01.jpg", relatedImage: "collections/thumb-break-power-related-5x3-01.jpg", tags: ["break", "power", "bundle"], related: ["break-cues", "jump-cues", "gloves"] },
    "difficult-shots": { title: "Make Difficult Shots", eyebrow: "Control under pressure", description: "Equipment suggestions for precise speed, cleaner delivery and greater confidence on demanding shots.", image: "collections/hero-difficult-shots-collection-desktop-01.jpg", mobileImage: "collections/hero-difficult-shots-collection-mobile-01.jpg", relatedImage: "collections/thumb-difficult-shots-related-5x3-01.jpg", tags: ["control", "jump", "shaft"], related: ["pool-cues", "jump-cues", "upgrade-my-shaft"] },
    "cases": { title: "Cue Cases", eyebrow: "Protect the equipment you trust", description: "Everyday and tournament protection sized for practical, organized travel.", image: "collections/hero-cases-collection-desktop-01.jpg", mobileImage: "collections/hero-cases-collection-mobile-01.jpg", relatedImage: "collections/thumb-cases-related-5x3-01.jpg", tags: ["case"], related: ["accessories", "gloves", "pool-cues"] },
    "gloves": { title: "Pool Gloves", eyebrow: "A consistent bridge on every table", description: "Performance gloves selected for low-friction movement, comfort and dependable fit.", image: "collections/hero-pure-pool-glove-collection-desktop-01.png", mobileImage: "collections/hero-pure-pool-glove-collection-mobile-01.png", relatedImage: "collections/thumb-pure-pool-glove-related-5x3-01.png", tags: ["glove"], related: ["accessories", "cases", "difficult-shots"] }
  };
  ...
  function renderGloveCollection() {
    ...
    $("[data-page-content]").innerHTML = `<nav class="store-breadcrumb container" aria-label="Breadcrumb"><a href="${path("index.html")}">Home</a><span>/</span><span aria-current="page">Pool Gloves</span></nav><section class="catalog-hero glove-hero"><div class="catalog-hero-media">${responsiveImage(collection.image, collection.mobileImage, "CUEBOTS Pure pool gloves", true)}</div><div class="container catalog-hero-copy"><p class="eyebrow">${collection.eyebrow}</p><h1>${collection.title}</h1><p>${collection.description}</p><a class="btn catalog-hero-cta" href="#glove-products">FIND YOUR GLOVE</a></div></section><section class="store-category-nav" aria-label="Shop other categories"><div class="container store-chip-rail">${Object.entries(COLLECTIONS).slice(0, 8).map(([slug, item]) => `<a class="store-chip${slug === PAGE ? " active" : ""}" href="${path(`pages/collection-${slug}.html`)}">${item.title}</a>`).join("")}</div></section>
      <section class="store-section glove-discovery"><div class="container"><div class="store-section-heading"><div><p class="eyebrow">Shop your way</p><h2>One glove or a ready-to-rotate pack</h2><p>Start with an individual color or save with a multi-pack built for regular play.</p></div></div><div class="glove-nav-grid"><a class="glove-nav-card" href="#glove-products">${responsiveImage("promotions/poster-pure-pool-glove-single-navigation-desktop-01.png", "promotions/poster-pure-pool-glove-single-navigation-mobile-01.png", "Shop individual CUEBOTS pool gloves")}<span><small>CHOOSE YOUR FIT</small><strong>Single gloves</strong><em>SHOP NOW →</em></span></a><a class="glove-nav-card" href="#glove-packs">${responsiveImage("promotions/poster-pure-pool-glove-pack-navigation-desktop-01.png", "promotions/poster-pure-pool-glove-pack-navigation-mobile-01.png", "Shop CUEBOTS pool glove packs")}<span><small>MORE VALUE, MORE COLORS</small><strong>Multi-buy packs</strong><em>SHOP PACKS →</em></span></a></div></div></section>
      <section class="store-section section-soft glove-hand-section"><div class="container glove-hand-panel"><div><p class="eyebrow">Fit starts here</p><h2>Which hand wears your glove?</h2><p>Select the hand that forms your bridge on the table. Your playing hand normally holds the cue without a glove.</p><div class="glove-hand-actions" role="group" aria-label="Choose glove hand"><button class="btn active" type="button" data-glove-hand="Left" aria-pressed="true">LEFT HAND</button><button class="btn btn-secondary" type="button" data-glove-hand="Right" aria-pressed="false">RIGHT HAND</button><button class="glove-guide-toggle" type="button" data-glove-guide aria-expanded="false">Not sure? See the hand guide</button></div></div><div class="glove-hand-visual">${image("sizing/size-pure-pool-glove-left-hand-en-1x1-01.png", "Left hand glove fit illustration")}${image("sizing/size-pure-pool-glove-right-hand-en-1x1-01.png", "Right hand glove fit illustration")}</div><div class="glove-hand-help" data-glove-hand-help hidden><strong>Quick check:</strong><span>If your left hand rests on the cloth and guides the shaft, choose Left Hand. If your right hand makes the bridge, choose Right Hand.</span></div></div></section>
      ...
      <section class="store-section glove-packs-section" id="glove-packs"><div class="container"><a class="glove-promo-banner" href="#glove-pack-products">${responsiveImage("promotions/poster-pure-pool-glove-multibuy-desktop-01.png", "promotions/poster-pure-pool-glove-multibuy-mobile-01.png", "Save more with CUEBOTS glove multi-buy packs")}<span><small>PLAY MORE. SAVE MORE.</small><strong>Build your glove rotation</strong><em>SHOP MULTI-BUY PACKS →</em></span></a><div class="store-section-heading"><div><p class="eyebrow">Multi-buy value</p><h2>Packs for practice and competition</h2><p>Keep a fresh glove in your case or share a color pack with your team.</p></div></div><div class="store-product-grid glove-pack-grid" id="glove-pack-products">${GLOVE_PACKS.map(productCard).join("")}</div></div></section>
      <section class="store-section section-soft"><div class="container"><a class="glove-promo-banner glove-complete-banner" href="#complete-your-game">${responsiveImage("promotions/poster-pure-pool-glove-complete-setup-desktop-01.png", "promotions/poster-pure-pool-glove-complete-setup-mobile-01.png", "Complete your CUEBOTS pool setup")}<span><small>COMPLETE YOUR GAME</small><strong>Pair a smoother bridge with protected, match-ready gear</strong><em>EXPLORE THE SETUP →</em></span></a><div id="complete-your-game" class="store-section-heading"><div><p class="eyebrow">Complete the setup</p><h2>Useful additions for your cue case</h2></div></div><div class="store-product-grid glove-setup-grid">${setupProducts.map(productCard).join("")}</div></div></section>
  ...
  function cartItemProduct(id) {
    ...
    return {
      ...
      image: String(saved.image || "assets/images/catalog/thumb-accessories-catalog-1x1-01.jpg").replace(/^.*assets[\\/]images[\\/]/i, "").replace(/\\/g, "/"),
      tags: ["accessory"],
